...
@section('content')
    ...
    <form action="{{ route('courses.store') }}" method="POST" class="bg-white shadow rounded-lg p-6 space-y-4">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('description') }}</textarea>
        </div>
